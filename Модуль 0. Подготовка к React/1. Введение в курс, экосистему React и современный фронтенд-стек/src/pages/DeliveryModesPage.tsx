  ...
  return (
    <div className="space-y-6">
      <SectionIntro
        ...
        copy="На этой странице вы учитесь выбирать не модный инструмент, а подход под конкретную задачу. Вы задаёте требования продукта и сразу видите, когда достаточно no-build контраста, когда нужен Vite, а когда задача уже уходит в зону React Router framework mode или Next.js."
      />
      ...
      <Panel className="grid gap-6 xl:grid-cols-2">
        ...
        <ListBlock
          ...
          items={[
            ...
            'CRA имеет историческое значение, но для новых приложений и нового курса здесь не используется как базовая стартовая точка.',
            'Framework-first нужен позже, когда задача реально выходит за пределы клиентского SPA и упирается в full-stack React.',
            'Этот проект сам построен как Vite SPA, а React Router framework mode и Next.js разобраны как следующий архитектурный слой.',
          ]}
        />
      </Panel>
