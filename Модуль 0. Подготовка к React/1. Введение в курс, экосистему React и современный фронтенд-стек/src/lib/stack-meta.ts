...
export const stackSummary =
  `React ${stackVersions.react}, Vite ${stackVersions.vite}, @vitejs/plugin-react ${stackVersions.viteReactPlugin}, Tailwind CSS ${stackVersions.tailwindcss}, Vitest ${stackVersions.vitest} и контейнерный запуск через Node ${stackVersions.nodeImage} + Nginx ${stackVersions.nginxImage}.`;
